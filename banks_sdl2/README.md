...
Adapted to wii with devkitpro in April 2026 by P.Sieg

The wii version uses USB keyboard and or wii remote. Hold wii remote same as for race game.

WPad left/right/up/down. A=reset left_right=0. B=de-/activate tilt sensor.

If tilt is activated, red rect is shown in upper left screen. left/right by tilt wii remote.
_
