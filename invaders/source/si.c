...
#define SCREEN_WIDTH 640 //800 = 0.8
#define SCREEN_HEIGHT 480 //600 = 0.8
#define E_WIDTH 30
#define WIDTH 480 //600 
...
void init_bases() {
	...
	load_image("sd:/apps/invaders/gfx/base.bmp", &base_img[0], magenta);
	load_image("sd:/apps/invaders/gfx/base.bmp", &base_img[1], magenta);
	load_image("sd:/apps/invaders/gfx/base.bmp", &base_img[2], magenta);
	load_image("sd:/apps/invaders/gfx/base.bmp", &base_img[3], magenta);
}
...
void draw_hud() {
	...
	draw_string(author, WIDTH, 432); //540
	
	char name[] = "J lambert";
	draw_string(name, WIDTH, 448); //560
}
...
int main(int argc, char *argv[]) {
	...
	//load images
	load_image("sd:/apps/invaders/gfx/titlescreen.bmp", &title_screen, magenta);
	load_image("sd:/apps/invaders/gfx/cmap.bmp", &cmap, magenta);
	load_image("sd:/apps/invaders/gfx/invaders.bmp", &invadersmap, magenta);
	load_image("sd:/apps/invaders/gfx/player.bmp", &player_img, magenta);
	load_image("sd:/apps/invaders/gfx/saucer.bmp", &saucer_img, magenta);
	load_image("sd:/apps/invaders/gfx/gameover.bmp", &game_over_img, magenta);
	load_image("sd:/apps/invaders/gfx/damage.bmp", &damage_img, lime);
	load_image("sd:/apps/invaders/gfx/damagetop.bmp", &damage_top_img, lime);
