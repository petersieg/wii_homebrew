// 10/2024 P. Sieg: move with left/right; esc ends game
...
const int SCREEN_WIDTH = 640; //800;
const int SCREEN_HEIGHT = 480; //600;

const int BRICK_WIDTH = 38; //48;
const int BRICK_HEIGHT = 16; //20;
...
int initPaddle(Paddle* paddle) {
    if (paddle){
        paddle->position.x = 280; //350;
        paddle->position.y = 440; //550;
        paddle->width = 80; //100;
        paddle->height = 16; //20;
        paddle->velocity.x = 0;
        paddle->velocity.y = 0;
...
int initBall(Ball* ball) {
    if (ball){
        ball->position.x = 316; //395;
        ball->position.y = 236; //295;
        ball->width = 8; //10;
        ball->height = 8; //10;
        ball->velocity.x = 0;
        ball->velocity.y = 0;
