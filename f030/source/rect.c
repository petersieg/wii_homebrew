/* simple SDL demo
   ...
   V0.2 - compiled to run on wii with devkitpro on 09/2024
*/   
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
void draw_bmp() {
  ...
  SDL_Surface* temp = SDL_LoadBMP("sd:/apps/f030/rect.bmp");
...
int main(int argc, char *argv[]) {
     ...
     /* load sky */
     temp  = SDL_LoadBMP("sd:/apps/f030/sky.bmp");
     sky = SDL_DisplayFormat(temp);
     SDL_FreeSurface(temp);
     
     /* load sprite */
     temp   = SDL_LoadBMP("sd:/apps/f030/sprite.bmp");
	...
	for (i=0; i<30; i++) {
     ...
     /* load sprite 1 */
     temp   = SDL_LoadBMP("sd:/apps/f030/maze1.bmp");
     sprite = SDL_DisplayFormat(temp);
     SDL_FreeSurface(temp);

     /* load sprite 2 */
     temp   = SDL_LoadBMP("sd:/apps/f030/maze2.bmp");
